...
1. Fork the `Sebagabones/userstyles` repository.
...
4. Copy the contents of the [`template`](https://github.com/Sebagabones/userstyles/tree/main/template) folder into `styles/<name-of-website>`.
...
7. Raise a [pull request](https://github.com/Sebagabones/userstyles/compare), making sure to read and fill out the template properly. The title of your pull request should follow the format of `feat(<name-of-website>): init`.
