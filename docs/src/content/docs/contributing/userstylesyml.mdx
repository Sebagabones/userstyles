...
The [`userstyles.yml`](https://github.com/Sebagabones/userstyles/tree/main/scripts/userstyles.yml) file is responsible for tracking all userstyle and maintainer metadata.

> [!TIP]
> The [`userstyles.schema.json`](https://github.com/Sebagabones/userstyles/tree/main/scripts/userstyles.schema.json) file is the schema specification for `userstyles.yml`. Please refer to it for clarification.
