...
1. Download the compiled Stylus export file, containing our recommended Stylus settings and all userstyles preloaded: [`import.json` (download)](https://github.com/Sebagabones/userstyles/releases/download/all-userstyles-export/import.json).
